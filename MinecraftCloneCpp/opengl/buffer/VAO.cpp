...
void VAO::LinkVBO(VBO vbo, GLuint layout, GLint elementCount, GLsizei stride, int offset )
{
	LOG_FUNC();
	...
	glVertexAttribPointer(layout, elementCount, GL_FLOAT, GL_FALSE,stride, (void*)offset);
